...
namespace BluLib
{
	public static class BluVectors
	{
		#region Set X/Y/Z
		...
		public static Vector3 OffsetX(this Vector3 vector, float x) => new(vector.x + x, vector.y, vector.z);

		public static Vector2 OffsetX(this Vector2 vector, float x) => new(vector.x + x, vector.y);

		public static void OffsetX(this Transform transform, float x) => transform.position = transform.position.OffsetX(x);

		// Offset Y
		
		public static Vector3 OffsetY(this Vector3 vector, float y) => new(vector.x, vector.y + y, vector.z);

		public static Vector2 OffsetY(this Vector2 vector, float y) => new(vector.x, vector.y + y);
		
		public static void OffsetY(this Transform transform, float y) => transform.position = transform.position.OffsetY(y);

		// Offset Z

		public static Vector3 OffsetZ(this Vector3 vector, float z) => new(vector.x, vector.y, vector.z + z);

		public static void OffsetZ(this Transform transform, float z) => transform.position = transform.position.OffsetZ(z);

		// Offset XY
		
		public static Vector3 OffsetXY(this Vector3 vector, float x, float y) => new(vector.x + x, vector.y + y, vector.z);
		
		public static Vector3 OffsetXY(this Vector3 vector, Vector2 offset) => vector.OffsetXY(offset.x, offset.y);

		public static Vector2 OffsetXY(this Vector2 vector, float x, float y) => new(vector.x + x, vector.y + y);
		
		public static void OffsetXY(this Transform transform, float x, float y) => transform.position = transform.position.OffsetXY(x, y);

		// Offset XZ

		public static Vector3 OffsetXZ(this Vector3 vector, float x, float z) => new(vector.x + x, vector.y, vector.z + z);
		...
		public static Vector3 OffsetYZ(this Vector3 vector, float y, float z) => new(vector.x, vector.y + y, vector.z + z);
		...
		public static Vector3 ToVector3(this Vector2 vector) => new(vector.x, vector.y);
		...
		public static Vector2Int ToVector2Int(this Vector2 vector) => new(vector.x.RoundToInt(), vector.y.RoundToInt());
		...
		public static Vector3 SnapValue(this Vector3 val, float snapValue) 
			=> new(val.x.Snap(snapValue), val.y.Snap(snapValue), val.z.Snap(snapValue));

		/// <summary>
		/// Snap to grid of snapValue
		/// </summary>
		public static Vector2 SnapValue(this Vector2 val, float snapValue) 
			=> new(val.x.Snap(snapValue), val.y.Snap(snapValue));
		...
		public static Vector2 SnapToOne(this Vector2 vector) 
			=> new(vector.x.Round(), vector.y.Round());
		...
		public static Vector3 AverageVector(this Vector3[] vectors)
		{
			...
			return new(x / vectors.Length, y / vectors.Length, z / vectors.Length);
		}
		...
		public static Vector2 AverageVector(this Vector2[] vectors)
		{
			...
			return new(x / vectors.Length, y / vectors.Length);
		}
		...
		{
			float xDiff = Mathf.Abs(vector.x - compared.x);
			float yDiff = Mathf.Abs(vector.y - compared.y);
			float zDiff = Mathf.Abs(vector.z - compared.z);
		...
		public static Vector2 Pow(this Vector2 source, float exponent) 
			=> new(Mathf.Pow(source.x, exponent), Mathf.Pow(source.y, exponent));
		...
		public static Vector3 Pow(this Vector3 source, float exponent) 
			=> new(Mathf.Pow(source.x, exponent), Mathf.Pow(source.y, exponent), Mathf.Pow(source.z, exponent));

		/// <summary>
		/// Raise each component of the source Vector3 to the specified power.
		/// </summary>
		public static Vector4 Pow(this Vector4 source, float exponent) 
			=> new(Mathf.Pow(source.x, exponent), Mathf.Pow(source.y, exponent), Mathf.Pow(source.z, exponent), Mathf.Pow(source.w, exponent));
