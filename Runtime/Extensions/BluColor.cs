...
namespace BluLib
{
	public static class BluColor
	{
		public static Color RandomBright => new(Random.Range(.4f, 1), Random.Range(.4f, 1), Random.Range(.4f, 1));

		public static Color RandomDim => new(Random.Range(.4f, .6f), Random.Range(.4f, .8f), Random.Range(.4f, .8f));

		public static Color RandomColor => new(Random.Range(.1f, .9f), Random.Range(.1f, .9f), Random.Range(.1f, .9f));

		/// <summary>
		/// Returns new Color with Alpha set to a
		/// </summary>
		public static Color WithAlphaSetTo(this Color color, float a) => new(color.r, color.g, color.b, a);
		...
		public static Color BrightnessOffset(this Color color, float offset) 
			=> new(color.r + offset, color.g + offset, color.b + offset, color.a);
