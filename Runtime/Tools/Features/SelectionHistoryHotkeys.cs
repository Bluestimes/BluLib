...
namespace BluLib.Internal
{
	...
	public static class SelectionHistoryHotkeys
	{
		...
		private static readonly Stack<Object> NextSelections = new();
		private static readonly Stack<Object> PreviousSelections = new();
		...
		private const string BackMenuLabel = "Tools/BluLib/Back In Selection History %#[";
		private const string ForwardMenuLabel = "Tools/BluLib/Forward In Selection History %#]";
