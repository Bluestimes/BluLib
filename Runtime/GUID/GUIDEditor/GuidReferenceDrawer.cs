...
namespace BluLib.Internal
{
	...
	public class GuidReferenceDrawer : PropertyDrawer
	{
		...
		GUIContent sceneLabel = new("Containing Scene", "The target object is expected in this scene asset.");
		GUIContent clearButtonGUI = new("Clear", "Remove Cross Scene Reference");
