	...
	public class SceneReference : ISerializationCallbackReceiver
	{
		...
		public void OnBeforeSerialize()
		{
			...
			if (Scene != null)
			{
				...
				(bool Present, bool Enabled, int Index) sceneInBuild = SceneReferenceUtils.GetSceneInBuildState(sceneAssetGUID);
	...
	public class SceneReferenceEditor : PropertyDrawer
	{
		...
		private Rect DisplayErrorsIfNecessary(Rect position)
		{
			if (errorStyle == null)
			{
				...
				errorTooltip = new("", "error");
			}

			if (sceneAsset == null)
				return position;

			Rect warningRect = new(position);
		...
		private void Validate()
		{
			if (sceneAsset != null)
			{
				(bool Present, bool Enabled, int Index) buildScene = SceneReferenceUtils.GetSceneInBuildState(sceneAssetGUID);
