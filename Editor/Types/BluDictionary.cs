...
{
	[Serializable]
	public class BluDictionary<TKey, TValue> : IDictionary<TKey, TValue>
	{
		...
		public BluDictionary() : this(0, null)
		{
		}

		public BluDictionary(int capacity) : this(capacity, null)
		{
		}

		public BluDictionary(IEqualityComparer<TKey> comparer) : this(0, comparer)
		{
		}

		public BluDictionary(int capacity, IEqualityComparer<TKey> comparer)
		{
		...
		public BluDictionary(IDictionary<TKey, TValue> dictionary) : this(dictionary, null)
		{
		}


		public BluDictionary(IDictionary<TKey, TValue> dictionary, IEqualityComparer<TKey> comparer)
		...
		public void CopyTo(KeyValuePair<TKey, TValue>[] array, int index)
		{
			...
			{
				if (_hashCodes[i] >= 0)
					array[index++] = new(_keys[i], _values[i]);
			}
		}
		...
		{
			private readonly BluDictionary<TKey, TValue> _dictionary;
			private readonly int _Version;
			private int _index;

			public KeyValuePair<TKey, TValue> Current { get; private set; }

			internal Enumerator(BluDictionary<TKey, TValue> dictionary) : this()
			{
			...
			public bool MoveNext()
			{
				...
				while (_index < _dictionary._count)
				{
					...
					{
						Current = new(_dictionary._keys[_index], _dictionary._values[_index]);
						_index++;
						return true;
					}
