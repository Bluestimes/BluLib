...
namespace BluLib.Internal
{
	public static class ConditionalUtility
	{
		...
		private static void LogFieldNotFound(Object owner, string field) => WarningsPool.LogWarning(owner,
			$"Conditional Attribute is trying to check field {field.Colored(Colors.brown)} which is not present",
			owner);
		public static void LogMethodNotFound(Object owner, string method) => WarningsPool.LogWarning(owner,
