...
namespace BluLib
{
	...
	/// </summary>
	public static class BluSceneBundle
	{
...
namespace BluLib.Internal
{
	...
	internal class Bundle<T>
	{
		...
		{
			return new(new Dictionary<string, T>(bundleData));
		}
		...
		{
			foreach (KeyValuePair<string, T> data in bundle)
			{
